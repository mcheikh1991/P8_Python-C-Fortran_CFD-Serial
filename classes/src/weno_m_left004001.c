...
void
weights_m_left004001 (const double *restrict sigma, int n, int ssi, int ssr,
  ...
  for (i = 4; i < n - 4; i++)
    {
      ...
      // Optimal weights
      d0 = 0.0285714285714286;
      d1 = 0.342857142857143;
      d2 = 0.514285714285714;
      d3 = 0.114285714285714;
...
PyObject *
py_weights_m_left004001 (PyObject * self, PyObject * args)
{
  double *sigma, *omega;
  ...
  weights_m_left004001 (sigma, n, ssi, ssr, omega, wsi, wsl, wsr);
