...
void
weights_m_right005001 (const double *restrict sigma, int n, int ssi, int ssr,
  ...
  for (i = 5; i < n - 5; i++)
    {
      ...
      // Optimal weights
      d0 = 0.0396825396825397;
      d1 = 0.317460317460317;
      d2 = 0.476190476190476;
      d3 = 0.158730158730159;
      d4 = 0.00793650793650794;
...
PyObject *
py_weights_m_right005001 (PyObject * self, PyObject * args)
{
  double *sigma, *omega;
  ...
  weights_m_right005001 (sigma, n, ssi, ssr, omega, wsi, wsl, wsr);
