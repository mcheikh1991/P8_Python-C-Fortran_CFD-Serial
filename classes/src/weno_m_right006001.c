...
void
weights_m_right006001 (const double *restrict sigma, int n, int ssi, int ssr,
  ...
  for (i = 6; i < n - 6; i++)
    {
      ...
      // Optimal weights
      d0 = 0.012987012987013;
      d1 = 0.162337662337662;
      d2 = 0.432900432900433;
      d3 = 0.324675324675325;
      d4 = 0.0649350649350649;
      d5 = 0.00216450216450216;
...
PyObject *
py_weights_m_right006001 (PyObject * self, PyObject * args)
{
  double *sigma, *omega;
  ...
  weights_m_right006001 (sigma, n, ssi, ssr, omega, wsi, wsl, wsr);
