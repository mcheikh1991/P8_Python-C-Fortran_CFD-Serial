...
void
weights_m_right003001 (const double *restrict sigma, int n, int ssi, int ssr,
...
PyObject *
py_weights_m_right003001 (PyObject * self, PyObject * args)
{
  double *sigma, *omega;
  ...
  weights_m_right003001 (sigma, n, ssi, ssr, omega, wsi, wsl, wsr);
